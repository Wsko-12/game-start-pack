...
import { Point2, Point3, Vector2, Vector3 } from '../../../../../utils/Geometry';
...
export default class CameraOrbitController extends CameraController {
    ...
    constructor(handlerElement: HTMLElement, position: Point3, target: Point3, camera: PerspectiveCamera) {
        super(handlerElement, position, target);
        this.camera = camera;
    }
    ...
    private moveTarget(unit: number): void {
        ...
        const targetPoint2 = new Point2(this.position.x, this.position.z);
        ...
        this.position.x = targetPoint2.x;
        this.position.z = targetPoint2.y;
    }
